...
V12_RESPEC_DESCRIPTION = "Research v1.2 failure-guided non-funding respec robustness variant."
V12_RESPEC_FAILURE_MODE = (
    "Failure-guided non-funding candidate variants may fail Research v1.2 robustness through BTC scope stress fragility, "
    "weak validation or blind windows, crash drawdown, friction sensitivity, or out-of-scope diagnostic concentration."
)
        ...
        rows.append(
            {
                ...
                "hypothesis": f"{candidate_id} failure-guided v1.2 respec variant {variant_id}.",
