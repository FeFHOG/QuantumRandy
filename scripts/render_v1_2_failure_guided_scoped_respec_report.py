...
def _render(
    *,
    ...
    lines = [
        ...
        "## Objective",
        "",
        "Research v1.2 re-specs a narrow non-funding cohort from v1.1 failure memory after the v1.1 clean negative "
        "result. It keeps `BTCUSDT_4h` as the declared scope and treats out-of-scope asset rows as diagnostics only.",
        "",
        "## Candidate Export",
        "",
...
def _artifact_paths(randyslab: Path) -> dict[str, Path]:
    return {
        "btc_review": randyslab / "reports/factor_candidate_review/research_v1_2_btc_primary",
        "eth_review": randyslab / "reports/factor_candidate_review/research_v1_2_eth_diagnostic",
        "sol_review": randyslab / "reports/factor_candidate_review/research_v1_2_sol_diagnostic",
        "bnb_review": randyslab / "reports/factor_candidate_review/research_v1_2_bnb_diagnostic",
        "avax_review": randyslab / "reports/factor_candidate_review/research_v1_2_avax_diagnostic",
        "correlation": randyslab / "reports/factor_candidate_correlation/research_v1_2_btc",
        "robustness": randyslab / "reports/factor_candidate_robustness/research_v1_2_failure_guided_respec",
    }
