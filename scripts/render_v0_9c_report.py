    ...
    *,
    ...
    lines.extend(
        [
            ...
            "- QuantumRandy full suite on 2026-07-03: `110 passed, 8 failed`; failures remain in pre-existing "
            "portfolio, portfolio-universe, runtime/scipy, selector-pipeline, smoke/scipy, and universe categories "
            "outside the v0.9c export, review, report, and failure-memory path.",
